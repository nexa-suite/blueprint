...
*(Entrega en la primera sesión de clase)*
- **Consideraciones:**
...
- **Debe incluir en el informe:**
  - [ ] Capítulo III: Solution UI/UX Design
  - [ ] Capítulo IV: Product Implementation & Validation (*Nota: En esta entrega se debe presentar el Sprint 1*)
  - [ ] Conclusiones
  - [ ] Bibliografía
  - [ ] Anexos.
...
- **Consideraciones:**
  - [ ] Debe incluir versión actualizada de Registro de Versiones del Informe, Project Report Collaboration Insights y Sección Student Outcome.
  - [ ] Debe incluir versión corregida y mejorada de artefactos previamente presentados.
  - [ ] [x] Debe estar desplegado el Landing Page.
...
- **Debe incluir en el informe:**
  - [ ] Capítulo IV: Product Implementation & Validation (*Nota: En esta entrega se debe presentar el Sprint 2*)
  - [ ] Conclusiones
  - [ ] Bibliografía
  - [ ] Anexos.
...
- **Consideraciones:**
  ...
  - [ ] Debe estar desplegado el Landing Page.
  - [ ] Debe estar desplegado al 100% el backend en un sitio público con su documentación.
  - [ ] **Debe presentarse la aplicación con todas las funcionalidades indicadas en el product backlog.**
...
- **Debe incluir en el informe:**
  - [ ] Capítulo IV: Product Implementation & Validation (*Nota: En esta entrega se debe presentar el Sprint 3*)
  - [ ] Se incluye además la versión final de: Conclusiones, Bibliografía y Anexos.
