...
### ENUNCIADO DEL TRABAJO FINAL (V4.0)

---

| Metadato | Detalle General | Configuración del Proyecto (Listo para Usar) |
| :--- | :--- | :--- |
| **PROFESORES** | Todos | Docente asignado |
| **NRC’s** | Todas | **4949** |
| **STARTUP / TEAM** | Nombre del equipo | **nexa-team** |
| **PERIODO ACADÉMICO** | 202620 | **2026-02 (202620)** |
| **FECHA DE EVALUACIÓN** | SEMANA 15 (TB2) | Hitos: Semana 4 (AV1), 7 (TB1), 12 (AV2), 15 (TB2) |
| **VERSIÓN DOCUMENTO** | V4.0 (52 Páginas Oficiales) | Transcripción íntegra al 100% |

---

> [!IMPORTANT]
> **GUÍA DE NAVEGACIÓN Y CUMPLIMIENTO TOTAL AL PIE DE LA LETRA**  
> Este documento contiene la transcripción **100% íntegra, textual y funcional** del Enunciado Oficial del Trabajo Final (V4.0). Cada requisito, regla de entrega, penalización, estructura de capítulos y formato de anexo es de **cumplimiento obligatorio**.

---

## 🎯 Configuración Oficial y Nomenclaturas Listas (`nexa-team` - NRC 4949)

Para evitar cualquier error en las entregas, a continuación se detallan los nombres exactos y preconfigurados para cada uno de los 4 hitos:

### 📦 Archivos de Entrega Principal por Hito

| Hito / Semana | Tipo de Documento | Formato | Nombre Oficial del Archivo (Listo para Copiar) |
| :--- | :--- | :--- | :--- |
| **AV1 (Semana 4)** | Informe del Proyecto | PDF | `upc-pre-202620-1acc0238-4949-nexa-team-report-av1.pdf` |
| | Presentación (Keynote) | PPTX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-keynote-av1.pptx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-keynote-av1.pdf` |
| | Reporte de Participación | DOCX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-performance-av1.docx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-performance-av1.pdf` |
| | Artefactos | ZIP | `upc-pre-202620-1acc0238-4949-nexa-team-artifacts-av1.zip` |
| | Video de Exposición | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-expo-av1.mp4` |
| **TB1 (Semana 7)** | Informe del Proyecto | PDF | `upc-pre-202620-1acc0238-4949-nexa-team-report-tb1.pdf` |
| | Presentación (Keynote) | PPTX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-keynote-tb1.pptx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-keynote-tb1.pdf` |
| | Reporte de Participación | DOCX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-performance-tb1.docx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-performance-tb1.pdf` |
| | Artefactos | ZIP | `upc-pre-202620-1acc0238-4949-nexa-team-artifacts-tb1.zip` |
| | Video de Exposición | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-expo-tb1.mp4` |
| **AV2 (Semana 12)** | Informe del Proyecto | PDF | `upc-pre-202620-1acc0238-4949-nexa-team-report-av2.pdf` |
| | Presentación (Keynote) | PPTX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-keynote-av2.pptx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-keynote-av2.pdf` |
| | Reporte de Participación | DOCX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-performance-av2.docx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-performance-av2.pdf` |
| | Artefactos | ZIP | `upc-pre-202620-1acc0238-4949-nexa-team-artifacts-av2.zip` |
| | Video de Exposición | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-expo-av2.mp4` |
| **TB2 (Semana 15)** | Informe del Proyecto | PDF | `upc-pre-202620-1acc0238-4949-nexa-team-report-tb2.pdf` |
| | Presentación (Keynote) | PPTX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-keynote-tb2.pptx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-keynote-tb2.pdf` |
| | Reporte de Participación | DOCX / PDF | `upc-pre-202620-1acc0238-4949-nexa-team-performance-tb2.docx`<br>`upc-pre-202620-1acc0238-4949-nexa-team-performance-tb2.pdf` |
| | Artefactos | ZIP | `upc-pre-202620-1acc0238-4949-nexa-team-artifacts-tb2.zip` |
| | Video de Exposición | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-expo-tb2.mp4` |

---

### 🎥 Nombres Oficiales de los Videos Requeridos (Anexo C)

| Video Requerido | Formato | Nombre Oficial del Archivo (Listo para Copiar) | Destino de Carga |
| :--- | :---: | :--- | :--- |
| **1. Needfinding Interviews** | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-needfinding-av1.mp4` | OneDrive docente + Enlace en Informe |
| **2. Prototypes Navigation** | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-prototypenavigation-tb1.mp4` | OneDrive docente + Enlace en Informe |
| **3. Validation Interviews** | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-validation-av2.mp4` (AV2)<br>`upc-pre-202620-1acc0238-4949-nexa-team-validation-tb2.mp4` (TB2) | OneDrive docente + Enlace en Informe |
| **4. About the Product** | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-about-the-product-av2.mp4` (AV2)<br>`upc-pre-202620-1acc0238-4949-nexa-team-about-the-product-tb2.mp4` (TB2) | OneDrive + YouTube (incrustado en Landing) |
| **5. About the Team** | MP4 | `upc-pre-202620-1acc0238-4949-nexa-team-about-the-team-av2.mp4` (AV2)<br>`upc-pre-202620-1acc0238-4949-nexa-team-about-the-team-tb2.mp4` (TB2) | OneDrive / Stream + YouTube (incrustado en Landing) |

---

## 🧭 Índice Rápido de Navegación

- 📌 [1. Objetivo y Logro del Curso](#objetivo)
- 📌 [2. Enunciado y Alcance de la Solución](#enunciado)
- 📌 [3. Exposición y Calificación Individual](#exposición)
- 📌 [4. Conformación del Equipo de Trabajo](#conformación-del-equipo-de-trabajo)
- 📌 [5. Instrucciones para la Entrega y Nomenclatura](#instrucciones-para-la-entrega-del-trabajo)
- 📌 [6. Recomendaciones Generales y Penalizaciones Críticas](#recomendaciones-generales)
- 📌 [7. Estructura Oficial del Informe (Índice de Secciones)](#estructura-del-informe)
- 📌 [8. Consideraciones Detalladas sobre los Componentes](#consideraciones-sobre-los-componentes)
- 📌 [9. Stack Tecnológico Oficial Permitido](#tecnología)
- 📌 [10. Evaluación del Trabajo Final (4 Hitos)](#evaluación-del-trabajo-final)
- 📌 [11. Referencias Oficiales](#referencias)
- 📌 [12. Anexos Oficiales](#anexos)
  - [Anexo A: Student Outcome ABET 7](#anexo-a-estructura-recomendada-para-la-sección-student-outcome)
  - [Anexo B: Performance Report (Team Leader)](#anexo-b-estructura-para-el-informe-de-participación)
  - [Anexo C: Guía Integral de Videos](#anexo-c-indicaciones-para-secciones-que-incluyen-videos)
  - [Anexo D: Ejemplo de Spike Story (Stripe)](#anexo-d-ejemplo-de-spike-story)
  - [Anexo E: Formato de Evaluación Heurística UX](#anexo-e-formato-para-evaluación-de-user-experience-según-heurísticas)
  - [Anexo F: Errores de Traducción y Términos Prohibidos](#anexo-f-errores-típicos-en-la-traducción-y-uso-de-términos-para-ingeniería-de-software)
  - [Anexo G: Categorías Bibliográficas y Papers Q1/Q2](#anexo-g-categorías-de-recursos-bibliográficos)
...
Este trabajo tiene por objetivo desarrollar un producto de software consistente en una **aplicación móvil nativa y multi plataforma** orientada a satisfacer necesidades identificadas para un público objetivo, haciendo uso de las herramientas y tecnología utilizadas en el curso, aplicando conceptos y técnicas revisados en clase o resultado de la investigación.

Como parte de las características a considerar en la aplicación móvil, debe incluirse:
1. El soporte de **almacenamiento local** de cierta información en el dispositivo.
2. Acceso a un **recurso interno del dispositivo**.
3. Integración con un **servicio RESTful de desarrollo interno**.
4. Acceso a algún **servicio externo de terceros**.
5. Además, el approach para el diseño para todos los productos de la solución es **Domain-Driven Design (DDD)**.

### Feature de Aprendizaje Autónomo
Se debe incorporar además, como componente esencial del alcance de la solución de software con aplicación móvil, un **feature que implique el aprendizaje autónomo**. Este feature deberá requerir que los estudiantes investiguen, evalúen e integren una tecnología, biblioteca o servicio diferente al utilizado en clase (por ejemplo, un SDK, una API, un framework de autenticación o una librería de visualización), justificando su selección y documentando el proceso de aprendizaje y aplicación.

### Demostración en Dispositivo Físico
Para la presentación de la aplicación como parte del trabajo final, se deberá utilizar un **dispositivo físico en el que la aplicación se encuentre previamente instalada y funcionando correctamente**. La demostración deberá realizarse directamente desde dicho dispositivo, evidenciando el funcionamiento de las principales funcionalidades implementadas.

### Landing Page
Se incluye como parte del alcance un **sitio web estático para el Landing Page** del modelo de negocio.

### Consistencia de la Solución
Es importante recalcar que toda la experiencia de solución presentada debe ser consistente, no solo en términos de funcionalidad, sino también en diseño, usabilidad e interacción, garantizando una experiencia coherente y fluida en todos los aspectos de la aplicación.
...
Un representante del equipo subirá al aula virtual, en la actividad indicada por el docente, los siguientes archivos:
1. **Documento de Informe del Proyecto** (en versión PDF).
2. **Documento de Presentación** (en versión PowerPoint y PDF).
3. **Reporte de Participación** (en versión Word y PDF).
4. **Archivo .zip con artefactos y proyectos de software** (si fuera aplicable).
5. **Video de exposición en formato .mp4**.

> [!NOTE]
> Tanto los artefactos y el proyecto de software así como el video de exposición, además de subirse al aula virtual, deben subirse a un **OneDrive** que será facilitado por el docente.
...
- **Presentación (keynote) del Proyecto:**  
  `upc-pre-<periodo>-1acc0238-<NRC>-<startup>-keynote-<avn/tbn>(.pptx y .pdf)`
- **Reporte de Participación:**  
  `upc-pre-<periodo>-1acc0238-<NRC>-<startup>-performance-<avn/tbn>(.docx y .pdf)`
- **Artefactos:**  
  `upc-pre-<periodo>-1acc0238-<NRC>-<startup>-artifacts-<avn/tbn>(.zip)`
- **Video de exposición:**  
  `upc-pre-<periodo>-1acc0238-<NRC>-<startup>-expo-<avn/tbn>(.mp4)`

> [!TIP]
> **Nota:** Los textos que van entre los símbolos `< >` (Ejemplo: `<periodo>`, `<NRC>`) deben ser reemplazados por la información correspondiente a su equipo.  
> *Ejm:* `upc-pre-202620-1acc0238-1824-nu34life-report-tb1.pdf`

---

### Pautas para cada documento

#### Informe del proyecto
El informe de proyecto se elaborará de forma colaborativa durante todo el ciclo de vida del proyecto, en el formato **Markdown** (organizado en uno o más archivos con extensión `.md`, siendo el archivo principal `README.md`) en un repositorio de control de versiones que forme parte de una **organización pública de GitHub**. Dicho repositorio debe evidenciar mediante commits los aportes de los miembros del equipo. Debe aplicar **GitFlow** y **Conventional Commits** para su creación y evolución. A partir de dicho repositorio se generan las exportaciones en formato `.pdf` para las entregas (AV1, TB1, AV2, TB2).
...
En la entrega del TB2 sí se debe considerar la totalidad del contenido correspondiente al trabajo de ciclo.

#### Reporte de Participación
Este documento es elaborado por el Team Leader, en el cual se detalla y evalúa el desempeño de cada miembro del equipo ([ver anexo B](#anexo-b-estructura-para-el-informe-de-participación)). En este documento, el Team Leader resume la participación de cada integrante y asigna una calificación individual en una escala de 0 a 20. Es obligatorio incluir el *Participant Performance Report* en cada entrega, evaluando específicamente el desempeño de los participantes en relación a la entrega correspondiente.
...
Para cada entrega, el equipo grabará en video su exposición con anticipación. El video contará de una edición que muestre la presentación de PowerPoint junto con la muestra en pantalla de artefactos como diagramas u otros que lo requieran, sincronizado con la explicación ante cámara de los participantes. En la primera parte de la exposición, debe incluirse tomas de cada participante hablando a la cámara y presentándose.  
El enlace privado del video debe incluirse en el Document Report, dentro de un anexo titulado *(Videos de Exposiciones)* y especificando la entrega a la que corresponde la Exposición. Debe entregarse además el archivo de video ([ver Anexo C](#anexo-c-indicaciones-para-secciones-que-incluyen-videos)).  
La duración máxima del video es de 15 minutos.
...
| :--- | :--- | :--- | :--- |
| 1.0.0 | YYYY-MM-DD | Apellidos, Nombres | Primera versión del informe / Creación inicial |
...
Para mayor información, consulte el libro *“Lean UX, 3rd Edition”* por Jeff Gothelf, Josh Seiden, disponible en O’Reilly.
...
| :--- | :--- | :--- | :--- | :--- |
| **¿Por qué llevar a cabo este análisis?** | \multicolumn{4}{l|}{Escriba en el recuadro la pregunta que busca responder o el objetivo de este análisis.} |
...
*Al comparar esta fortaleza con la competencia, se observa que, aunque los competidores también innovan, nuestra velocidad de implementación de nuevas funciones y la calidad de estas son superiores, lo que nos permite mantener una ventaja competitiva en el mercado.*
...
| :--- | :--- | :--- | :--- |
| **Title** | [Título] | | |
| **Description** | Como... deseo... para... | | |
| **Acceptance Criteria** | **Scenario 1:** ...<br>**Given** [contexto]<br>**When** [evento]<br>**Then** [resultado] | | |
...
*Ejemplo de Spike Story: Investigar la Integración de Stripe para el Procesamiento de Pagos en la Plataforma ACME Learning Center. ([Ver anexo D](#anexo-d-ejemplo-de-spike-story)).*
...
En esta sección se introduce y explica el proceso realizado para las decisiones de nivel estratégico aplicando Domain-Driven Design. El equipo explica y evidencia el proceso para descomponer el sistema en subconjuntos con límites naturales o Bounded Contexts. Para ello debe aplicar las herramientas de EventStorming y Bounded Context Canvas.
...
En esta sección el equipo, a partir del dominio modelado como EventStorm, explica y evidencia el proceso realizado para la sesión de Candidate Context Discovery, en la que se busca identificar los bounded contexts. Puede aplicar las técnicas de:
- *start-with-value* (Identificar las partes core del dominio que tienen el mayor valor para el negocio),
- *start-with-simple* (Crear modelos simples, pero con propósito, descomponiendo el timeline en steps secuenciales), ó
- *look-for-pivotal-events* (Buscar eventos clave del negocio que indiquen cambios de estado entre diferentes partes del proceso de negocio).  
La sesión de Candidate Context Discovery no debería durar más de 2 horas. Utilice para el proceso la herramienta indicada. Complemente la explicación con capturas en imagen de los cambios progresivos del EventStorm.
...
Debe finalizar este proceso discutiendo cada alternativa de context mapping a fin de llegar a la mejor aproximación. Es importante que el equipo considere los patrones de relaciones entre Bounded Contexts establecidos en Domain-Driven Design, como **Anti-corruption Layer (ACL)**, **Conformist**, **Customer/Supplier** ó **Shared Kernel**.

### Software Architecture
En esta sección el equipo presenta y explica la representación, aplicando C4 Model y utilizando la herramienta indicada, de la Arquitectura de Software para la solución, incluyendo todos los productos que forman parte de su alcance. Aquí se realiza una introducción y se incluye como secciones internas:
...
- **Domain Layer:** En esta capa el equipo explica por medio de qué clases representará el core de la aplicación y las reglas de negocio que pertenecen al dominio para el bounded context. Aquí el equipo presenta clases de categorías como Entities, Value Objects, Aggregates, Factories, Domain Services, o abstracciones representadas por interfaces como en el caso de Repositories.
- **Interface Layer:** En esta sección el equipo introduce, presenta y explica las clases que forman parte de Interface/Presentation Layer, como clases del tipo Controllers o Consumers.
- **Application Layer:** En esta sección el equipo explica a través de qué clases se maneja los flujos de procesos del negocio. En esta sección debe evidenciarse que se considera los capabilities de la aplicación en relación al bounded context. Aquí debe considerarse clases del tipo Command Handlers e Event Handlers.
- **Infrastructure Layer:** En esta capa el equipo presenta aquellas clases que acceden a servicios externos como databases, messaging systems o email services. Es en esta capa que se ubica la implementación de Repositories para las interfaces definidas en Domain Layer. Algo similar ocurre con interfaces definidas para MessageBrokers.
...
- **Landing Page Wireframe:** Esta sección incluye una sección interna donde se presenta y explica los Wireframes del Landing Page para Desktop Web Browser y Mobile Web Browser. En la propuesta y la explicación debe evidenciarse la aplicación de los principios, elementos de diseño, diseño inclusivo y arquitectura de información.
- **Landing Page Mock-up:** Esta sección presenta y explica los Mock-ups del Landing Page, tanto en su versión para Desktop Web Browser como Mobile Web Browser. En la propuesta y la explicación debe evidenciarse la aplicación de los principios, elementos de diseño, diseño inclusivo y arquitectura de información, así como el Design System establecido para los productos digitales.
...
#### Sprint n
En esta sección se registra y explica el avance en términos de producto y trabajo colaborativo para el Sprint n. Incluye como secciones internas:
- **Sprint Planning n:** En esta sección se especifica los aspectos principales del Sprint Planning Meeting. Se inicia la sección con una introducción y a continuación se coloca el cuadro de resumen del sprint planning meeting. La estructura a utilizar se presenta a continuación:
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| Jiménez Rosas, Arturo Eduardo | ajimenezrosas | L | C | … | C |
...
- **Diseño de Entrevistas:** En esta sección el equipo establece por cada segmento objetivo los elementos a incluir en la sesión de validación, incluyendo el Landing Page y las aplicaciones. Aquí se especifica también cuáles serán los user flows de las aplicaciones, que formarán parte del proceso de validación.
- **Registro de Entrevistas:** Para cada segmento se requiere de **3 a 5 entrevistas**. Para cada una de las entrevistas se debe indicar la información de nombres, apellidos, edad, distrito, un screenshot de un cuadro de video y el URL del video subido en el OneDrive facilitado por el docente, incluyendo el timing donde inicia la entrevista y su duración. La entrevista debe ser registrada en video, que sirve de evidencia de entrevistas. Para cada entrevista debe redactarse en este informe un resumen, que explique de forma descriptiva las principales apreciaciones del entrevistado con respecto a las tareas asignadas. Ver otras indicaciones importantes en el [Anexo C. Indicaciones para secciones que incluyen Videos](#anexo-c-indicaciones-para-secciones-que-incluyen-videos).
- **Evaluaciones según heurísticas:** Esta sección contiene el proceso de evaluación de las sesiones de validación basado en heurísticas, considerando heurísticas de usabilidad, arquitectura de información e inclusive design de la experiencia propuesta. Para esto la sección debe contener la estructura del formato para evaluaciones de heurísticas indicado en el [Anexo E. Formato para Evaluación de User Experience según Heurísticas](#anexo-e-formato-para-evaluación-de-user-experience-según-heurísticas).
...
**Importante:** El informe final debe incluir estos puntos:
...
2. Asimismo, en la Bibliografía se debe considerar categorías de recursos bibliográficos. Las categorías de referencia para investigación incluyen: a) dominio de negocio; b) métodos, técnicas, approaches aplicados en ciclo de ingeniería de software; c) lenguajes, frameworks y herramientas para desarrollo de software utilizados. Adicionalmente, se requiere que dichas fuentes bibliográficas sean citadas de forma explícita con el formato APA en el documento de Final Project Report ([ver anexo G](#anexo-g-categorías-de-recursos-bibliográficos)).
...
## Evaluación del Trabajo Final y Rúbricas Oficiales

El trabajo se evalúa en **4 hitos progresivos e integrados**, cada uno calificado sobre **20 puntos**.

```mermaid
timeline
    title Ciclo de Evaluación Oficial (1ACC0238)
    Semana 4 : AV1 - Sprint Review (20 pts) : Capítulos I y II completos : Strategic & Tactical DDD (11 BCs)
    Semana 7 : TB1 - Stage Review (20 pts) : Landing 100% : Backend 70% : Mobile Core Screens (Sprint 1)
    Semana 12 : AV2 - Sprint Review (20 pts) : Backend 100% : Mobile Feature Autónomo + Hardware (Sprint 2) : Videos Iniciales
    Semana 15 : TB2 - Release Review (20 pts) : Release v1.0.0 : Despliegue en Firebase App Distribution : Todos los Videos Finales : ABET 7 Evaluado
```
...
| ❌ **Insuficiente** | **0 Punto(s)** | No comunica en forma oral ni escrita su propuesta de forma incipiente o vaga, en el marco del desarrollo de un proyecto de software.<br>5 Punto(s) |
...
| ❌ **Insuficiente** | **0 Punto(s)** | No comunica en forma oral ni escrita su propuesta<br>Punto(s) |
...
# SECCIÓN MAESTRA ABET: STUDENT OUTCOMES 7 Y 3
## Evaluación de Competencias Profesionales y Acreditación Internacional (ABET EAC)

El curso **1ACC0238 Aplicaciones para Dispositivos Móviles** evalúa de forma directa y rigurosa el **Student Outcome 7 de ABET (EAC)** y el **Student Outcome 3 (Comunicación)**. Esta sección constituye la norma de evaluación individual para asegurar el nivel **Sobresaliente ([20 - 16> puntos)** en la acreditación.

---

### 🏛️ Matriz Oficial de Evaluación ABET EAC - Student Outcome 7
*(Fuente: `abet-7-rubric.xlsx` de la Facultad de Ingeniería - Carrera de Ingeniería de Software UPC)*

> **Definición del Outcome ABET 7:**  
> *"La capacidad de adquirir y aplicar nuevos conocimientos según sea necesario, utilizando estrategias de aprendizaje apropiadas."*

| Criterio Específico | Ponderación | Nivel Sobresaliente `[10 - 8>` | Nivel Esperado `[8 - 7]` / `[8 - 6]` | Nivel Necesita Mejora `<7 - 0]` / `<6 - 0]` |
| :--- | :---: | :--- | :--- | :--- |
| **7.c1. Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de ingeniería de software.** | `10 pts` | 1. **Demuestra capacidad para asimilar y aplicar nuevas tecnologías, herramientas, nuevos conocimientos metodológicos y de procesos explicando fortalezas y debilidades en el ámbito de aplicación.**<br>2. **Demuestra capacidad para asimilar y aplicar conocimientos de más de un dominio de aplicación.**<br>3. **Demuestra dominio de técnicas o métodos para la investigación.** | 1. Demuestra capacidad para asimilar y aplicar nuevas tecnologías, herramientas, nuevos conocimientos metodológicos y de procesos.<br>2. Demuestra capacidad para asimilar y aplicar conocimientos de un dominio de aplicación.<br>3. Aplica técnicas o métodos para la investigación. | 1. Demuestra parcialmente capacidad para asimilar y aplicar nuevas tecnologías, herramientas, nuevos conocimientos metodológicos y de procesos.<br>2. Demuestra parcialmente capacidad para asimilar y aplicar conocimientos de un dominio de aplicación.<br>3. Aplica parcialmente técnicas o métodos para la investigación. |
| **7.c2. Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de tecnologías de ingeniería de software.** | `10 pts` | 1. **Identifica y documenta áreas de crecimiento profesional donde le interesaría desarrollarse luego de graduarse.**<br>2. **Define rigurosamente un plan de crecimiento profesional alineado con las áreas de interés dentro de la profesión (2 Objetivos SMART de carrera profesional).** | 1. Identifica áreas de crecimiento profesional donde le interesaría desarrollarse luego de graduarse.<br>2. Define un plan de crecimiento profesional alineado con las áreas de interés dentro de la profesión. | 1. Aunque reconoce la necesidad de mantenerse actualizado, no demuestra capacidad para identificar áreas de crecimiento profesional donde podría desarrollarse luego de graduarse.<br>2. Demuestra dificultad para preparar un plan de crecimiento profesional alineado con las áreas de interés dentro de la profesión. |
| **Puntaje General ABET 7** | `20 pts` | **[20 - 16> Puntos** | **[16 - 13] Puntos** | **<13 - 0] Puntos** |

---

### 🗣️ Matriz de Evaluación ABET - Student Outcome 3: Comunicación Efectiva (3.c2)

> **Definición del Criterio 3.c2 (Communication):**  
> *"Comunica en forma oral y escrita su propuesta con objetividad, en el marco del desarrollo de un proyecto de solución de software basado en tecnologías para la transformación digital, cumpliendo con los requisitos y estructura de presentación, artefactos y entregables solicitados, cuidando la correcta ortografía y gramática en la comunicación."*

| Nivel de Desempeño | Puntaje | Descriptor Oficial |
| :--- | :---: | :--- |
| 🌟 **Sobresaliente** | **2.0 Puntos** | Comunica en forma oral y escrita su propuesta con objetividad, en el marco del desarrollo de un proyecto de software, cumpliendo de forma impecable con la estructura de presentación, artefactos y entregables, cuidando la ortografía, gramática, estilo APA 7 y claridad expositiva. |
| ✅ **Esperado** | **1.0 Punto** | Comunica en forma oral y escrita su propuesta con objetividad, cumpliendo parcialmente con los requisitos y estructura, o con algunos errores menores de ortografía, formato o gramática. |
| ⚠️ **Necesita Mejorar** | **0.5 Puntos** | Comunica en forma oral y escrita su propuesta pero de forma incipiente o vaga, o incumple con la estructura de presentación, o presenta reiteradas fallas ortográficas o gramaticales. |
| ❌ **Insuficiente** | **0.0 Puntos** | No comunica en forma oral ni escrita su propuesta. |

---

### 📝 Guía de Redacción Individual de la Sección Student Outcome para cada Estudiante

En el informe del proyecto (tanto en el cuerpo preliminar como en el Anexo A), cada participante del equipo debe redactar de forma **individual y acumulativa** sus aportes para los dos criterios de ABET 7 a lo largo de las cuatro entregas (AV1, TB1, AV2, TB2):

#### 1. Criterio 7.c1: Actualización de Conceptos y Métodos de Investigación
Cada alumno debe detallar:
- **Tecnologías y herramientas asimiladas:** Explicar qué tecnología aprendió de manera autónoma (ej. Jetpack Compose, KMP, Room con SQLCipher, Spring Boot CGLIB, WorkManager, Coroutines Flow, Swagger/OpenAPI), destacando **sus fortalezas y debilidades técnicas**.
- **Múltiples dominios de aplicación:** Evidenciar cómo articuló el dominio de la solución (ej. gestión de suministros B2B, logística de frío, e-commerce móvil) con el dominio técnico de arquitectura de software (DDD, C4, GitFlow, Microservicios).
- **Técnicas de investigación:** Explicar cómo aplicó métodos de investigación científica y técnica (análisis de papers indexados en Scopus/IEEE Q1/Q2, análisis competitivo de benchmarking, needfinding con entrevistas semiestructuradas y pruebas de usabilidad).

#### 2. Criterio 7.c2: Reconocimiento de la Necesidad de Aprendizaje Continuo y Plan SMART
Cada alumno debe incluir:
- **Áreas de interés post-graduación:** Identificar y documentar nichos profesionales donde planea desarrollarse (ej. Mobile Systems Architecture, Cloud-Native Engineering, DevSecOps, Distributed Systems, Data Engineering).
- **Dos (2) Objetivos SMART Individuales de Carrera Profesional:** Formular un plan de acción riguroso que cumpla con la metodología SMART:
  - **S (Specific):** Acción y certificación o proyecto concreto (ej. *Obtener la certificación Google Associate Android Developer* o *Publicar un framework Open Source de persistencia offline en Kotlin*).
  - **M (Measurable):** Métrica verificable (ej. *Score ≥ 85% en el examen oficial*, *100 estrellas en GitHub*, *Completar 120 horas de laboratorios prácticos*).
  - **A (Achievable):** Recursos y viabilidad (ej. *Dedicando 8 horas semanales los fines de semana a los tracks de Google Developers y proyectos piloto*).
  - **R (Relevant):** Justificación de impacto profesional (ej. *Permitirá calificar a roles de Mobile Architect en empresas de escala regional*).
  - **T (Time-bound):** Fecha límite exacta (ej. *Dentro de los 6 meses posteriores a la fecha de graduación - Diciembre 2027*).

---

### 💡 Ejemplo Validado de Objetivo SMART Individual (Formato de Alta Calificación)

> **Objetivo SMART 1 (Certificación Profesional Especializada):**  
> *"Obtener la certificación oficial **Google Associate Android Developer** en un plazo no mayor a 8 meses tras culminar el pregrado (Agosto 2027), dedicando 10 horas semanales al estudio guiado de Jetpack Compose, Arquitectura Limpia y Seguridad en Android, y aprobando el examen práctico de codificación con una calificación mínima del 85%, con el fin de consolidarme como Mobile Software Engineer en el sector Fintech."*
>
> **Objetivo SMART 2 (Contribución y Portafolio Tecnológico):**  
> *"Desarrollar y publicar una biblioteca de código abierto en Kotlin Multiplatform para la sincronización resiliente de bases de datos offline-first en GitHub, logrando al menos 50 estrellas y un coverage de pruebas unitarias superior al 90% dentro de los 12 meses posteriores a la graduación (Diciembre 2027), evidenciando liderazgo técnico en sistemas distribuidos móviles ante reclutadores internacionales."*
...
- Ubiquitous Language: Unambiguously define the term and concepts of a business domain:  
...
| :--- | :--- | :--- |
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **[Apellidos, Nombres 1]:**<br>• **AV1:** [Acciones realizadas...]<br>• **TB1:** [Acciones realizadas...]<br>• **AV2:** [Acciones realizadas...]<br>• **TB2:** [Acciones realizadas...]<br><br>**[Apellidos, Nombres 2]:**<br>• **AV1:** [...] | *(Llenado grupal y acumulable a lo largo de las entregas...)* |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **[Apellidos, Nombres 1]:**<br>• **AV1:** [...]<br>• **TB1:** [...]<br><br>**[Apellidos, Nombres 2]:**<br>• **AV1:** [...] | *(Llenado grupal y acumulable a lo largo de las entregas...)* |
...
- **Estructura del nombre de archivo:**  
  `upc-pre-202620-1acc0238-4949-nexa-team-performance-<avn/tbn>(.docx y .pdf)`
- **Condición:** Adjuntar el archivo en todas las entregas programadas junto al final Project.

### Participant Performance Report

| Participant Performance Report | | | |
| :--- | :--- | :--- | :--- |
| **Nombre de Startup** | nexa-team | **Nombre de Producto** | Nexa Suite |
| **Entrega** | AV1 / TB1 / AV2 / TB2 | **Team Leader** | [Apellidos, Nombres del Líder] |
...
| :---: | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| 1 | [Estudiante 1] | Responsabilidad 1... | X | | | | 20 |
| | | Responsabilidad 2... | | X | | | |
| 2 | [Estudiante 2] | Responsabilidad 1... | X | | | | 20 |
| … | … | … | | | | | |
| n | [Estudiante n] | No participó | | | | X | 0 |
...
| :--- | :--- | :--- | :--- |
| **Needfinding Interviews** | • **Cantidad de videos:** 1<br>• **Nomenclatura:** `upc-pre-202620-1acc0238-4949-nexa-team-needfinding-<avn/tbn>(.mp4)`<br>• **Formato:** `.mp4`<br>• **Duración:** En función a cantidad de entrevistas (considerar edición de 3 a 5 minutos por entrevista). | Consolida todas las entrevistas realizadas, incluyendo en cada entrevista títulos con información del entrevistado, el segmento objetivo y la fecha de la entrevista. | • Subir el video en el OneDrive indicado por el docente.<br>• Incluir en el informe screenshot del video con enlace al mismo.<br>• Incluir redacción de introducción a la sección y registro de cada entrevista, así como el análisis general donde se identifican las variables y los valores representativos a nivel objetivo y subjetivo que servirán de base para la definición de los User Persona. Seguir especificaciones del enunciado. |
| **Prototypes Navigation / Product Navigation** | • **Cantidad de videos:** 1<br>• **Nomenclatura:** `upc-pre-202620-1acc0238-4949-nexa-team-prototypenavigation-<avn/tbn>(.mp4)`<br>• **Formato:** `.mp4`<br>• **Duración:** En función a cantidad de user flows de aplicaciones (considerar edición de 3 a 5 minutos por aplicación). | Consolida demostración del flujo de navegación del Landing Page y las aplicaciones, priorizando los user flows relacionados con el core business. | • Subir el video en el OneDrive indicado por el docente.<br>• Incluir en el informe screenshot del video con enlace al mismo.<br>• Incluir redacción de introducción a la sección, resumiendo los flujos de navegación que se incluyen en el video. |
| **Validation Interviews** | • **Cantidad de Videos:** 1<br>• **Nomenclatura:** `upc-pre-202620-1acc0238-4949-nexa-team-validation-<avn/tbn>(.mp4)`<br>• **Formato:** `.mp4`<br>• **Duración:** En función a cantidad de entrevistas (considerar edición de 3 a 5 minutos por entrevista). | Consolida sesiones y entrevistas de validación en las que usuarios de los segmentos objetivo interactúen con el landing page y con la aplicación móvil, manifestando sus observaciones. Para cada entrevista se debe incluir títulos con información del entrevistado, el segmento objetivo y la fecha de la entrevista. | • Subir el video en el OneDrive indicado por el docente.<br>• Incluir en el informe screenshot del video con enlace al mismo.<br>• Incluir redacción de introducción a la sección y redacción de registro de cada entrevista, junto con la evaluación de heurísticas de usabilidad, arquitectura de información y diseño inclusivo para la sesión de evaluación. Seguir especificaciones del enunciado y formatos indicados. |
| **About the Product** | • **Cantidad de videos:** 1<br>• **Nomenclatura:** `upc-pre-202620-1acc0238-4949-nexa-team-about-the-product-<avn/tbn>(.mp4)`<br>• **Formato:** `.mp4`<br>• **Duración:** De 1 a 2 minutos. | Orientación promocional, resumiendo el modelo de negocio, las características y beneficios del producto, incluyendo algunas escenas de interacción con el producto y al menos una opinión por cada segmento objetivo. | • Subir el video en el OneDrive indicado por el docente y en YouTube.<br>• Incluir en el informe screenshot del video con enlace al mismo.<br>• Incluir redacción de introducción a la sección.<br>• Adicionalmente, **incrustar el video en una sección adecuada del Landing Page**. Seguir especificaciones del enunciado. |
| **About the Team** | • **Cantidad de videos:** 1<br>• **Nomenclatura:** `upc-pre-202620-1acc0238-4949-nexa-team-about-the-team-<avn/tbn>(.mp4)`<br>• **Formato:** `.mp4`<br>• **Duración:** En función al contenido (considerar 5 minutos para la sección de retrospectiva del grupo y 1 minuto por cada testimonio de miembro del equipo). | Video que resume el proceso de trabajo realizado, incluyendo escenas de sesiones de trabajo real del equipo, complementando con narración (voz en off) del proceso. Incluye además el testimonio ante cámara de cada participante describiendo actividades realizadas, logro del student outcome y desarrollo de competencias alcanzados. | • Subir el video en el OneDrive indicado por el docente y en YouTube.<br>• Incluir redacción de introducción a la sección, resumiendo el proceso de trabajo y los logros alcanzados por los miembros del equipo.<br>• Adicionalmente, **incrustar el video en una sección adecuada del Landing Page**. Seguir especificaciones del enunciado. |
...
7. **Verifica los Requisitos de Cumplimiento**
   ...
   - **Cuando** el desarrollador revisa las características de cumplimiento de Stripe (e.g., minimización de datos en Stripe.js/Mobile SDKs, almacenamiento seguro en Spring Boot con JPA),
   - **Entonces** el desarrollador documenta cualquier consideración de cumplimiento o pasos adicionales necesarios en el informe.

8. **Identifica Dependencias y Costos**
   - **Dado** la necesidad de entender las dependencias externas para la integración de Stripe,
   - **Cuando** el desarrollador investiga las configuraciones requeridas (e.g., cuenta de Stripe, Stripe.js en package.json de Angular, Mobile SDKs en build.gradle de KMM, `stripe-java` en pom.xml de Spring Boot, webhooks),
   - **Entonces** el desarrollador lista las dependencias y señala cualquier costo asociado (e.g., tarifas por transacción, características premium) en el informe.

9. **Prototipa la Integración de Stripe**
   - **Dado** la necesidad de validar la viabilidad de Stripe,
   - **Cuando** el desarrollador construye un proof-of-concept mínimo (e.g., un flujo de pago de prueba en Angular 20 usando Stripe.js/Elements, en KMM usando Mobile SDKs, integrado con endpoints REST de Spring Boot 3.5.5 para Payment Intents),
   - **Entonces** el PoC es funcional, registrado en una rama del repositorio, y referenciado en el informe.

10. **Estima el Esfuerzo**
    - **Dado** que el equipo necesita una estimación de esfuerzo para la implementación de Stripe,
    - **Cuando** el desarrollador desglosa la integración en tareas de web (Angular 20), móvil (KMM), y backend (Spring Boot 3.5.5 con Java 24) basadas en los hallazgos del Spike (e.g., configuración de componentes Angular: 4 horas, configuración de Mobile SDK: 5 horas, API de backend: 7 horas),
...
11. **Documenta y Comparte los Hallazgos**
    ...
    - **Entonces** el informe incluye pros/contras, enfoque recomendado (e.g., usar Checkout alojado vs. flujo personalizado en web/móvil), y cualquier bloqueador, y es revisado en una reunión de equipo o sesión de refinamiento.
...
Nexa Suite Mobile Application

#### TAREAS A EVALUAR:
El alcance de esta evaluación incluye la revisión de la usabilidad de las siguientes tareas:
1. Registro de un usuario nuevo
2. Publicación de un post / creación de registro
3. Búsqueda de recursos y servicios
4. Solicitud y reserva de servicio
5. Cancelación de una operación
6. Agregar ítems a un pedido
7. Pago y procesamiento de transacción
8. Etc.

**No están incluidas en esta versión de la evaluación las siguientes tareas:**
1. Compartir recursos entre usuarios externos
2. Presentar ofertas avanzadas de fidelización
3. Administrar puntos del programa de beneficios
4. Guardar alertas personalizadas
5. Etc.
...
| :--- | :--- | :--- | :--- |
| **Library** | Biblioteca | Librería | Error común producto de la semejanza fonética, pero biblioteca (library) y librería (bookstore) tienen significados diferentes. |
| **Requirement** | Requisito | Requerimiento | Error común debido a la semejanza fonética, sin embargo, requisito (requirement) y requerimiento (request) tienen diferente significado. |
| **Request** | Solicitud / Petición / Requerimiento | Requisito | Consecuencia de la traducción incorrecta de requirement. |
| **Application** | Aplicación | Aplicativo | Aplicativo en español no existe como sustantivo. Aplicativo es un sustantivo solo en portugués. |
| **Elicit** | Obtener | Elicitar | Elicitar no existe en español. |
...
- Técnicas de especificación de requisitos (User Stories, Impact Mapping, entre otros).
...
> [!IMPORTANT]
> **RECORDATORIO SOBRE PAPERS ACADÉMICOS OBLIGATORIOS:**  
> La Bibliografía debe incluir como mínimo **4 papers de fuentes académicas indexadas en Scopus/Web of Science ubicadas en cuartiles Q1 o Q2**, con no más de **dos (2) años de antigüedad**:
> - **2 papers** enfocados en el dominio del problema / negocio.
> - **2 papers** enfocados en técnicas y tecnologías para desarrollo de aplicaciones móviles empleadas en el proyecto.
> 
> *Todas las fuentes deben estar citadas de forma explícita en el cuerpo del informe en formato APA 7.*
