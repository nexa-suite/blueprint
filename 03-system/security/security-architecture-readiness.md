...
Current evidence includes global authentication/session mechanisms, role and permission checks, tenant/workspace access context, RLS mechanisms, audit/security tests, provider adapters and worker/background processing. The [AS-IS evidence package](../../06-delivery/as-is/README.md) records the boundaries and gaps.
