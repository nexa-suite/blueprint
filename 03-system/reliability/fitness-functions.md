...
|---|---|---|
| V1 C4 has exactly six V1 containers; Runway future containers remain separate | `03-system/c4/structurizr/workspace.dsl` and generated workspace | PASS after validator run |
