...
The canonical flow views are [Buyer sales](../../02-domain/processes/workflows.md#1-buyer-sales-flow),
[Warehouse and delivery](../../02-domain/processes/workflows.md#2-warehouse-and-delivery-flow),
[Payment and receivable](../../02-domain/processes/workflows.md#3-payment-and-receivable-flow)
and [durable events](../../02-domain/processes/workflows.md#4-durable-business-events).
