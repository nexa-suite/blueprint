...
- ClamAV, Mailpit, Stripe mock, OTEL Collector y Jaeger son infraestructura/adapters locales; se documentan en la [evidencia de runtime](../../06-delivery/as-is/compose-runtime-architecture-evidence.md), no en el L1 ni en la lista primaria L2.
...
La semántica de identidad global, membership workforce, Buyer relationship, propagación de contexto y RLS se detalla separadamente en [Multi-tenant context propagation](../security/multi-tenancy/context-propagation.md). La organización lógica se detalla en [Logical system layering](../architecture/layering/logical-system-layering.md).
