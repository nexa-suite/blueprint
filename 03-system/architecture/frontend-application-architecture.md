...
- Route guards improve navigation; backend authorization remains authoritative. Product workflow/state semantics are in [Frontend Product Contract](../../04-web/design/information-architecture.md) and [UI State Contract](../../04-web/quality/ui-state-contract.md).
