...
|---|---|---|
| V1 C4 has exactly six V1 containers; Runway future containers remain separate | `04-architecture/c4/structurizr/workspace.dsl` and generated workspace | PASS after validator run |
...
| Selective C4 L3/L4 views are explicit; deployment remains absent | Structurizr workspace and code views | PASS after validator run; review-gated |
| Strategic DDD outputs are proposed and linked | Domain discovery readiness | PROPOSED / READY FOR BUSINESS ARCHITECT REVIEW |
