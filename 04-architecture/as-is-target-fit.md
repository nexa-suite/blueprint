...
| Warehouse reservations | REWORK, not rewrite | FEFO, lots, reservations and concurrency exist; Product closes Commercial Commitment (SKU + quantity) versus Physical Allocation (Inventory Lot(s)) | Translate current reservation terms to the closed Product distinction; preserve current tables during transition | Dual-read/translation period; physical-truth shortage, transfer, allocation and temperature tests |
