...
| Mobile | KEEP PROJECTION + DEFER CLIENT | Product direction is OWNER-ACCEPTED; API v0.17.0 is PARTIAL; Mobile repository is documentation-only with no native client/build/runtime | Keep Operations Mobile and Buyer Mobile over the accepted 11 BCs; preserve implementation runway and no V1 runtime claim | Research validation, client architecture, provider/device decisions, authenticated acceptance and production gates before implementation |
