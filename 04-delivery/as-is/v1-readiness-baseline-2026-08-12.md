...
Authority remains defined by [Source of truth](../../01-shared/engineering/governance/source-of-truth.md) and [Current accepted decisions](../../01-shared/product/current-decisions.md).
...
The accepted C4 model is defined in [Structurizr README](../../01-shared/architecture/c4/structurizr/README.md) and [workspace.dsl](../../01-shared/architecture/c4/structurizr/workspace.dsl).
...
- [V1 scope](../../01-shared/product/vision/v1-scope.md).
- [Primary personas](../../02-web/actors/personas.md).
- [Known domain rules](../../01-shared/domain/business-rules/README.md).
- [Architecture drivers](../../01-shared/architecture/drivers/initial-drivers.md).
