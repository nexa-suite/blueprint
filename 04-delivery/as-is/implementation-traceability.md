...
| Mobile and driver workflows | Mobile | [Mobile rebaseline](../../03-mobile/README.md) | Product direction OWNER-ACCEPTED; 49 retained stories (28 V1 candidates, 21 V2/deferred); API PARTIAL; client NOT STARTED; no V1 runtime claim |
