...
Catalogue evidence, legacy references, verified flows and safe bibliography pointers. Reference material informs decisions but does not become TARGET authority by itself.

## Authoritative content

- [AS-IS evidence package](as-is/README.md).
...
TARGET authority, copied repositories, secrets, database dumps, unverified claims, or external copyrighted books/PDFs prepared for publication.

## Related areas

[Governance](../00-governance/README.md), [Product](../01-product/README.md), [Domain](../02-domain/README.md), [Architecture](../04-architecture/README.md).
