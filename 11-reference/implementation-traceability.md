...
This matrix connects product knowledge to independent repositories and
evidence. It is an AS-IS index; repository presence does not mean every flow
is production-ready.

| Capability / surface | Repository evidence | Blueprint authority | Classification |
| --- | --- | --- | --- |
| Identity, Tenant, access | API, Platform, Portal | [Known rules](../02-domain/business-rules/known-rules.md), [C4 L3/L4](../04-architecture/c4/l3-l4-views.md) | AS-IS; target ownership proposed |
| Customer and Buyer relationships | API, Platform, Portal | [Business knowledge](../02-domain/business-knowledge.md), [Strategic DDD](../02-domain/strategic-ddd/README.md) | AS-IS distributed; target review-gated |
...
| Credit, receivables, payments | API, Platform, Portal | [Business rules](../02-domain/business-rules/known-rules.md), [Payment workflow](flows/workflows.md) | Formula accepted; ownership review-gated |
| Documents and notifications | API, Platform, Portal | [C4 L3/L4](../04-architecture/c4/l3-l4-views.md) | AS-IS adapters/projections; ownership proposed |
...
- Dated implementation baselines are snapshots, not automatically current runtime proof.
