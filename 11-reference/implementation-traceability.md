...
| Business traceability | API, Platform, Portal | [Business ownership](../02-domain/strategic-ddd/business-ownership-matrix.md), [Traceability ADR](../04-architecture/adrs/adr-0011-durable-business-traceability.md) | AS-IS evidence; BC-11 target accepted |
