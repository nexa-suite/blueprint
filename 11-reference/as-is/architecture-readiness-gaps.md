...
| BLOQUEO | Angular authenticated SSR/deployment contract: current apps are Angular browser builds served by Nginx. | No verified SSR/hydration, authenticated SSR, edge routing or production deployment contract is present in this baseline. | Cloud/Deployment Architecture; Security Architecture |
