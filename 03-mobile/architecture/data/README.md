...
The v0.17.0 backend concepts are consumed as remote contracts: SKU/GTIN and
lot resolution, Physical Allocation scan validation, Delivery Handoff Token,
Buyer Receipt/Discrepancy and Push Subscription. Local queues may hold safe
references/evidence only; they never become a Mobile database authority.
