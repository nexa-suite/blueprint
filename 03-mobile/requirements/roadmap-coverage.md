...
| Feature family | Canonical coverage | Historical planning band coverage | Disposition |
|---|---|---|---|
| Foundation and secure access | MOB-US-001..003; TS-015, TS-020 | Historical V1 | Covered by access, context and authorization outcomes. |
| Warehouse receiving and picking | MOB-US-011..017, MOB-US-019; MOB-US-050..056, MOB-US-073 | Historical V1 to V4/Future | The V1 generation envelope retains the narrow safe flow; refinement provenance distinguishes later outcomes. |
| Dispatch and handoff | MOB-US-020..025; MOB-US-057..061 | Historical V1 to V3 | Exceptions, reassignment, grouped loads, carrier handoff and dispatch temperature evidence are separate outcomes. |
