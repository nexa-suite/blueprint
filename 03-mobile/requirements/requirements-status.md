...
|---|---|---|
| Product generation | ACCEPTED | Nexa Mobile V1 is the course-end coherent Mobile Product Generation planning envelope for all 73 canonical stories. |
...
release and lifecycle state lives in [master-mobile-backlog.md](master-mobile-backlog.md).
Research evidence and solution validation remain separate. Story-specific
research status remains in the master backlog and catalog; segment-level
Needfinding does not automatically close each solution story.
