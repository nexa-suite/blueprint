...
This file remains the single Product / Business V1 authority. The Strategic DDD package in [Shared Domain](../domain/README.md) accepts business boundaries without changing frozen scope. Commitment existence, expiry, consent semantics, Credit formula, delivery continuation and payment/order failure handling are closed here.
