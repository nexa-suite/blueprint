...
| GLOBAL_REFERENCE | Shared immutable reference or policy metadata; no tenant ownership. |
...
global reference-like policy metadata; its classification is GLOBAL_REFERENCE
and grants remain scoped through BC-01 rows.
