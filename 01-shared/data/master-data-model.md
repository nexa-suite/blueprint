...
| BC-05 | `warehouse`, `inventory_lot`, `inventory_position`, `inventory_movement`, `safety_stock_policy`, `inventory_reservation`, `inventory_reservation_line`, `warehouse_backing`, `warehouse_backing_line`, `physical_allocation`, `physical_allocation_line`, `inventory_adjustment`, `warehouse_transfer`, `warehouse_transfer_line`, `lot_disposition` |
...
`commercial_commitment_id` and `sku_id`, and owns Inventory Reservation,
Warehouse Backing and Physical Allocation. BC-06 stores `sales_order_id` and
