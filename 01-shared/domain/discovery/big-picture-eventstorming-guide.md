...
1. [Source of truth](../../engineering/governance/source-of-truth.md)
2. [Current accepted decisions](../../product/current-decisions.md)
3. [Strategic DDD](../../domain/strategic-ddd/README.md)
4. [EventStorming baseline](../../domain/processes/eventstorming.md)
5. [Domain Stories](../../domain/processes/domain-stories.md)
6. [Business ownership matrix](../../domain/ownership/business-ownership-matrix.md)
7. [Ubiquitous Language](../../domain/ubiquitous-language/glossary.md)
8. [Integration and Event Architecture](../../architecture/integrations/README.md)
9. [Canonical Bounded Context canvases](../../domain/bounded-contexts/README.md)
...
|---|---|---|
| Tenant / relationship | `TenantProvisioningRequested`, `TenantActivated`, `WorkforceMembershipGranted`, `BuyerRelationshipApproved` | [EventStorming](../../domain/processes/eventstorming.md) |
| Commercial intent | `CartDraftCreated`, `AuthoritativePriceResolved`, `PurchaseRequestSubmitted` | [EventStorming](../../domain/processes/eventstorming.md) |
| Commitment | `CommercialCommitmentEstablished`, `CreditReservationEstablished`, `SalesOrderConfirmed` | [BC-04 Sales Commitment](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) |
| Availability | `StockReceived`, `LotCreated`, `SellableAvailabilityChanged`, `AllocationExecuted` | [BC-05 Inventory Availability](../../domain/bounded-contexts/BC-05-inventory-availability/README.md) |
| Fulfillment | `FulfillmentPlanned`, `FulfillmentAllocated`, `PickingCompleted`, `Packed`, `Staged`, `ReadyForDispatch` | [BC-06 Fulfillment & Delivery](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) |
| Delivery | `HandedOver`, `DeliveryDispatched`, `DeliveryAttempted`, `DeliveryCompleted` | [Workflows](../../domain/processes/workflows.md) |
| Financial/document evidence | `ReceivablePosted`, `PaymentReported`, `PaymentConfirmed`, `BusinessDocumentIssued` | [Published events](../../domain/events/published-events.md) |
| Traceability | `BusinessFactTraced`, `NotificationDeliveryFailed` | [Domain message flows](../../domain/processes/message-flows.md) |
...
Usa este inventario inicial, reducido a hechos del [baseline canónico](../../domain/processes/eventstorming.md):
...
[EventStorming PRE-V1 baseline](../../domain/processes/eventstorming.md),
[published event contracts](../../domain/events/published-events.md),
y [Ubiquitous Language](../../domain/ubiquitous-language/glossary.md).
...
[Canonical V1 workflows](../../domain/processes/workflows.md),
[EventStorming baseline](../../domain/processes/eventstorming.md),
y [Domain message flows](../../domain/processes/message-flows.md).
...
[Current accepted decisions](../../product/current-decisions.md),
[Domain Stories](../../domain/processes/domain-stories.md),
y [Strategic decision register](../../domain/ownership/strategic-decision-register.md).
...
[Strategic DDD](../../domain/strategic-ddd/README.md),
[Business ownership matrix](../../domain/ownership/business-ownership-matrix.md),
y [Canonical workflows](../../domain/processes/workflows.md).
...
[Shared actors](../../product/actors.md),
[BC-04 Sales Commitment](../../domain/bounded-contexts/BC-04-sales-commitment/README.md),
[BC-06 Fulfillment & Delivery](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md),
y [BC-08 Payments](../../domain/bounded-contexts/BC-08-payments/README.md).
...
[EventStorming baseline](../../domain/processes/eventstorming.md),
[BC-07 Credit & Receivables](../../domain/bounded-contexts/BC-07-credit-receivables/README.md),
y [BC-10 Notifications](../../domain/bounded-contexts/BC-10-notifications/README.md).
...
[Ubiquitous Language](../../domain/ubiquitous-language/glossary.md),
[Business ownership matrix](../../domain/ownership/business-ownership-matrix.md),
[Domain message flows](../../domain/processes/message-flows.md),
y [API target query rules](../../architecture/api-architecture-target.md).
...
|---|---|---|
| `Payment Provider` | report/callback de pago; `Payment` traduce el lenguaje externo mediante ACL | [C4](../../architecture/c4/README.md) |
| `Email Delivery Service` | envío, retry y terminal failure de `Notification` | [C4](../../architecture/c4/README.md) |
| `Maps & Geolocation Provider` | apoyo a ruta/geolocalización durante `Delivery`, sujeto a las decisiones de provider | [C4](../../architecture/c4/README.md) |
...
[Integration architecture](../../architecture/integrations/README.md)
y [C4 System Context](../../architecture/c4/README.md).
...
[Canonical Bounded Contexts](../../domain/bounded-contexts/README.md),
[BC-04 tactical design aid](../../domain/bounded-contexts/BC-04-sales-commitment/README.md),
[BC-05 tactical design aid](../../domain/bounded-contexts/BC-05-inventory-availability/README.md),
[BC-06 tactical design aid](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md),
[BC-07 tactical design aid](../../domain/bounded-contexts/BC-07-credit-receivables/README.md),
y [BC-08 tactical design aid](../../domain/bounded-contexts/BC-08-payments/README.md).
...
y [Business ownership matrix](../../domain/ownership/business-ownership-matrix.md).
...
2. `Domain Message Flows Modeling`: usar [Domain Storytelling / Domain
   Stories](../../domain/processes/domain-stories.md) y [Domain
   Message Flows](../../domain/processes/message-flows.md), no
   sustituirlos por una secuencia de controllers o endpoints.
3. `Bounded Context Canvases`: usar el [índice canónico de los 11 canvases](../../domain/bounded-contexts/README.md)
...
El [Ubiquitous Language canónico](../../domain/ubiquitous-language/README.md)
...
|---|---|---|---|---:|---|
| `CartDraftCreated` | `CartDraftCreated` | Domain Event | [EventStorming](../../domain/processes/eventstorming.md) | 1 | Draft no crea commitment. |
| `PurchaseRequestSubmitted` | `PurchaseRequestSubmitted` | Domain Event | [EventStorming](../../domain/processes/eventstorming.md) | 1 | Public contract: `.v1`. |
| `CommercialCommitmentEstablished` | `CommercialCommitmentEstablished` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | Demand Warehouse-neutral. |
| `SalesOrderConfirmed` | `SalesOrderConfirmed` | Domain Event | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 1 | SO nace `CONFIRMED`. |
| `AllocationExecuted` | `AllocationExecuted` | Domain Event | [BC-05](../../domain/bounded-contexts/BC-05-inventory-availability/README.md) | 1 | Public contract: `PhysicalAllocationCreated.v1`. |
| `FulfillmentPlanned` | `FulfillmentPlanned` | Domain Event | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 1 | Inicia ejecución operativa. |
| `DeliveryCompleted` | `DeliveryCompleted` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | Después de POD inmutable. |
| `PartialDeliveryRecorded` | `PartialDeliveryRecorded` | Domain Event | [EventStorming](../../domain/processes/eventstorming.md) | 1 | Rama excepcional. |
| `ContinuationDeliveryCreated` | `ContinuationDeliveryCreated` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | No es otro attempt. |
| `PaymentConfirmed` | `PaymentConfirmed` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | Provider-neutral. |
| `ReceivablePosted` | `ReceivablePosted` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | Credit/net, sin doble conteo. |
| `BusinessDocumentIssued` | `BusinessDocumentIssued` | Domain Event | [Published events](../../domain/events/published-events.md) | 1 | Issued history inmutable. |
| `Customer Buyer` | `Customer Buyer` | Actor | [Actors](../../product/actors.md) | 5 | Buyer Relationship autorizada. |
| `Sales Representative` | `Supplier Tenant: Sales Representative` | Actor | [Actors](../../product/actors.md) | 5 | Assisted commercial work. |
| `Warehouse Operator` | `Supplier Tenant: Warehouse Operator` | Actor | [Actors](../../product/actors.md) | 5 | Receiving and fulfillment. |
| `Dispatch Coordinator` | `Supplier Tenant: Dispatch Coordinator` | Actor | [Actors](../../product/actors.md) | 5 | Dispatch and handoff. |
| `Driver / Delivery Operator` | `Supplier Tenant: Driver / Delivery Operator` | Actor | [Actors](../../product/actors.md) | 5 | Attempt and POD. |
| `SubmitPurchaseRequest` | `SubmitPurchaseRequest` | Command | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 5 | Imperative intention. |
| `ConfirmSalesOrder` | `ConfirmSalesOrder` | Command | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 5 | No Draft SO. |
| `RecordDeliveryOutcome` | `RecordDeliveryOutcome` | Command | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 5 | Can yield partial/failure. |
| `ReportPayment` | `ReportPayment` | Command | [BC-08](../../domain/bounded-contexts/BC-08-payments/README.md) | 5 | Report != Confirmed. |
| `CreateContinuation` | `CreateContinuation` | Command | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 6 | Triggered by partial result. |
| `ApplyPayment` | `ApplyPayment` | Command | [BC-07](../../domain/bounded-contexts/BC-07-credit-receivables/README.md) | 6 | Idempotent application. |
| `CommitmentAcceptancePolicy` | `CommitmentAcceptancePolicy` | Policy | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 6 | Domain policy/design aid. |
| `PartialDeliveryPolicy` | `PartialDeliveryPolicy` | Policy | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 6 | Continuation semantics. |
| `Available Credit` | `Available Credit` | Read Model | [Glossary](../../domain/ubiquitous-language/glossary.md) | 7 | Decision information, not table. |
| `Sellable Availability by SKU + Warehouse` | `Sellable Availability` | Read Model | [BC-05](../../domain/bounded-contexts/BC-05-inventory-availability/README.md) | 7 | Physical authority projected. |
| `Delivery and POD Timeline` | `Business Traceability` projection | Read Model | [BC-11](../../domain/bounded-contexts/BC-11-business-traceability/README.md) | 7 | Authorized projection. |
| `Payment Provider` | `Payment Provider` | External System | [C4](../../architecture/c4/README.md) | 8 | Abstract external boundary. |
| `Email Delivery Service` | `Email Delivery Service` | External System | [C4](../../architecture/c4/README.md) | 8 | Retryable delivery. |
| `Maps & Geolocation Provider` | `Maps & Geolocation Provider` | External System | [C4](../../architecture/c4/README.md) | 8 | Provider decision remains open. |
| `PurchaseRequest` | `PurchaseRequest` | Aggregate | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 9 | Accepted TARGET design aid. |
| `CommercialCommitment` | `CommercialCommitment` | Aggregate | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 9 | No Warehouse/Lot selection. |
| `SalesOrder` | `SalesOrder` | Aggregate | [BC-04](../../domain/bounded-contexts/BC-04-sales-commitment/README.md) | 9 | Confirmed obligation. |
| `InventoryReservation` | `InventoryReservation` | Aggregate | [BC-05](../../domain/bounded-contexts/BC-05-inventory-availability/README.md) | 9 | Backing, not allocation. |
| `PhysicalAllocation` | `PhysicalAllocation` | Aggregate | [BC-05](../../domain/bounded-contexts/BC-05-inventory-availability/README.md) | 9 | Selects lot(s). |
| `Fulfillment` | `Fulfillment` | Aggregate | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 9 | Pick/pack/stage. |
| `Delivery` | `Delivery` | Aggregate | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 9 | Attempts, POD, continuation. |
| `BC-04 Sales Commitment` | `BC-04 Sales Commitment` | Bounded Context | [Strategic DDD](../../domain/strategic-ddd/README.md) | 10 | Core ownership. |
| `BC-05 Inventory Availability` | `BC-05 Inventory Availability` | Bounded Context | [Strategic DDD](../../domain/strategic-ddd/README.md) | 10 | Core physical truth. |
| `BC-06 Fulfillment & Delivery` | `BC-06 Fulfillment & Delivery` | Bounded Context | [Strategic DDD](../../domain/strategic-ddd/README.md) | 10 | Core execution/evidence. |
| `BC-11 Business Traceability` | `BC-11 Business Traceability` | Bounded Context | [Strategic DDD](../../domain/strategic-ddd/README.md) | 10 | Separate from Notifications. |
| `Insufficient availability` | availability protection hotspot | Pain Point | [Current decisions](../../product/current-decisions.md) | 3 | Explain commitment/backing/allocation distinction. |
| `Partial delivery` | remaining obligation hotspot | Pain Point | [Domain Stories](../../domain/processes/domain-stories.md) | 3 | Continuation is explicit. |
| `Commercial intent -> confirmed obligation` | `PurchaseRequestSubmitted` / `SalesOrderConfirmed` | Pivotal Point | [Workflows](../../domain/processes/workflows.md) | 4 | Do not equate with BC boundary. |
| `Physical execution -> terminal evidence` | `DeliveryCompleted` | Pivotal Point | [BC-06](../../domain/bounded-contexts/BC-06-fulfillment-delivery/README.md) | 4 | POD remains immutable. |
