...
| Failure / transaction | PR submission, commitment, complete Inventory Reservation and Warehouse Backing, and applicable credit reservation are one logical PostgreSQL transaction; idempotency and revision protect retries/conflicts. |
...
- [Rendered UML SVG](diagrams/BC04_SalesCommitment.svg)
- [Rendered UML PNG](diagrams/BC04_SalesCommitment.png)
