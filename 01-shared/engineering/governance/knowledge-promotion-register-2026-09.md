...
Post-AV1 Wave 1 rebase. Classification preserves provenance; it is not itself
Owner acceptance.
...
| Mobile Report C4/DDD/UML/PlantUML/PNG/SVG | `DERIVED_ACADEMIC_PROJECTION` | [Model authority](../../architecture/model-authority.md) | Wave 2 reconciliation; no shared C4/DDD promotion in Wave 1 |
