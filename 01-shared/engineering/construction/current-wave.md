...
Runway status describes implementation and research maturity. It does not authorize new code, Bounded Contexts or technical topology. The current selective C4 L3/L4 PRE-V1 target is documented separately; mobile remains a projection over the accepted 11 BCs and is not current V1 runtime evidence.
