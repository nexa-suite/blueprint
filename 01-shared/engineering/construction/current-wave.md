...
|---|---|---|---|---|---|
| Nexa Mobile (Operations + Buyer) | ACCEPTED TARGET / IMPLEMENTATION OPEN | Operations is Android/Kotlin/Jetpack Compose; Buyer is Flutter/Dart Android+iOS; 73-story Product Generation and Needfinding 9/9 are baselined | Solution validation, API contracts, UX, security and Product Acceptance | Historical bands 28/35/9/1 retained as provenance; Operations partial unmerged evidence; Buyer not implemented | Accepted client architecture, workflow evidence and Product Acceptance |
...
Runway status describes implementation and research maturity. It does not authorize new code, Bounded Contexts or technical topology. The current selective C4 L3/L4 TARGET is documented separately; Mobile remains a projection over the accepted 11 BCs and is not current integrated runtime evidence.
