...
| BC-04 Sales Commitment | Nexa API, Platform, Buyer Portal, Mobile TARGET planning projections | `Nexa-API-CommercialInventory-TARGET`; Platform/Portal frontend views | PASS — commitment application/domain seams cover PR/SO; Mobile client NOT STARTED |
| BC-05 Inventory Availability | Nexa API, Platform, Buyer Portal, Operations Mobile TARGET planning projection | `Nexa-API-CommercialInventory-TARGET`; `Nexa-API-FulfillmentDelivery-TARGET`; Platform/Operations Mobile views | PASS — inventory authority, backing/allocation and consumers visible |
