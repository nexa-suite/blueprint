...
Canonical source: [Product vision](../product/vision/product-vision.md).

Product / Business V1 input: **FROZEN / CLOSED**. No major Product blocker remains. This historical record did not create strategic boundaries; the accepted result now lives in [Strategic DDD](../domain/strategic-ddd/README.md).
...
Mobile, Delivery Driver, Control Center, Support, subscriptions, plans, entitlements, feature tiers and IoT remain runway or V2/future according to [V1 scope](../product/vision/v1-scope.md).

## Primary personas

The eight V1 personas are canonicalized in [Primary personas](../../02-web/actors/personas.md): Prospective Customer Representative, Tenant Administrator, Company Owner, Business Operations Manager, Sales Representative, Warehouse Operator, Dispatch Coordinator and B2B Buyer.
...
The accepted rules include Tenant isolation, Tenant 1:1 Workspace in V1, single-Warehouse physical lots, source-batch traceability, Purchase Request adjustment and bounded expiry, cart non-reservation, authoritative pricing protection, credit hard block and explicit/auditable Sales Order changes. See [Known domain rules](../domain/business-rules/README.md).
...
- [V1 readiness baseline](../../04-delivery/as-is/v1-readiness-baseline-2026-08-12.md).
- [Current state](../../00-start-here/status.md).
...
- [Local runtime baseline](../../04-delivery/as-is/local-runtime-baseline.md).
