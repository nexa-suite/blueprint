...
- Route guards improve navigation; backend authorization remains authoritative. Product workflow/state semantics are in [Frontend Product Contract](../design/design-system/web-evidence/information-architecture.md) and [UI State Contract](../../02-web/ux/quality/ui-state-contract.md).
