...
Detailed source classifications remain in the [frontend reference map](../11-reference/legacy-ecosystem-report/frontend-reference-map.md), [validation findings](../11-reference/legacy-ecosystem-report/validation-findings.md), [artifact classification](../11-reference/legacy-ecosystem-report/artifact-classification.md) and [asset provenance](../11-reference/legacy-ecosystem-report/asset-provenance.md). Binary assets marked `REVIEW_BEFORE_REPUBLICATION` remain local.
