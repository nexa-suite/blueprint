...
The first slice is the smallest traceable path that crosses identity/scope, commercial commitment, availability, fulfillment visibility, notification/traceability and both Platform/Portal projections. The [vertical slice contract](../../03-system/architecture/vertical-slice-contract.md) defines required evidence; it does not claim that the slice is implemented.
