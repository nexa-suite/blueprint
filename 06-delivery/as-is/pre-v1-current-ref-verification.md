...
runtime proof and production certification remain separate gates. See [current state](../../00-start-here/current-status.md),
[accepted decisions](../../00-start-here/current-decisions.md) and the
