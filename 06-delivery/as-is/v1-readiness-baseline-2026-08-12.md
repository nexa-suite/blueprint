...
Authority remains defined by [Source of truth](../../00-start-here/source-of-truth.md) and [Current accepted decisions](../../00-start-here/current-decisions.md).
...
The accepted C4 model is defined in [Structurizr README](../../03-system/c4/structurizr/README.md) and [workspace.dsl](../../03-system/c4/structurizr/workspace.dsl).
...
- [V1 scope](../../01-product/vision/v1-scope.md).
- [Primary personas](../../01-product/audiences/web-personas.md).
- [Known domain rules](../../02-domain/business-rules.md).
- [Architecture drivers](../../03-system/architecture/drivers/initial-drivers.md).
