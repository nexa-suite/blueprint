...
[![Status](https://img.shields.io/badge/status-PRE--V1%20baselined-2563EB?style=flat-square)](00-governance/current-state.md) [![C4](https://img.shields.io/badge/C4-L1%20%2B%20L2%20%2B%20selective%20L3%20baselined-0F766E?style=flat-square)](04-architecture/c4/README.md) [![Validation](https://img.shields.io/badge/validation-local-64748B?style=flat-square)](tooling/scripts/validate-blueprint.sh)
...
It does not contain application source as Blueprint content, production cloud decisions, secrets or copied external copyrighted material. PRE-V1 Strategic DDD and construction TARGET architecture are accepted as documentation; production gates remain explicitly open. Local application checkouts under `10-repositories/` are workspace material only.
...
| Capability Mapping, EventStorming, Domain Storytelling | BASELINED |
| Strategic DDD, Bounded Contexts, Context Map | ACCEPTED; 11 FROZEN |
| C4 Level 3/4 | SELECTIVE TARGET BASELINED |
| TARGET data, security and application architecture | CLOSED FOR PRE-V1 CONSTRUCTION |
| Production cloud/deployment architecture | OPEN — PRODUCTION GATE |
...
<tr><td><a href="04-architecture/README.md"><strong>Architecture</strong></a><br />C4, ADRs, AS-IS audit and PRE-V1 TARGET.</td><td><a href="05-data/README.md"><strong>Data</strong></a><br />AS-IS evidence and accepted PRE-V1 ownership/concurrency.</td></tr>
...
C4 Level 3/4 technical views and TARGET data/security/application construction contracts are baselined by accepted ownership decisions; production deployment remains an open gate.
