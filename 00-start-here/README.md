...
- **Requirements**: [Web](../02-web/requirements/README.md) with 15 Epics / 133 confirmed stories; [Mobile](../03-mobile/requirements/README.md) with 7 Epics / 49 retained stories (42 V1, 7 V2/deferred); [shared delivery](../01-shared/product/requirements/README.md) with 20 Technical Stories / 6 Spikes.
