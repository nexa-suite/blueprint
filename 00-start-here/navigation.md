...
| tooling | How validate? | Repository-local scripts and local tools. |
...
Use [Shared actors](../01-shared/product/actors.md), [Shared capabilities](../01-shared/product/capability-map.md), [11 Bounded Contexts](../01-shared/domain/bounded-contexts/README.md), [DDD](../01-shared/domain/strategic-ddd/README.md) and [C4](../01-shared/architecture/c4/README.md) as domain and architecture context.
