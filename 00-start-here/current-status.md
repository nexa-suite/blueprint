...
- Accessible repository refs and exact limitations are recorded in [current-ref verification](../06-delivery/as-is/pre-v1-current-ref-verification.md), the [AS-IS implementation audit](../06-delivery/as-is/architecture-implementation-audit.md) and [AS-IS evidence](../06-delivery/as-is/README.md).
