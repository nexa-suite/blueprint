...
- [Bounded Context catalog](bounded-contexts/canonical-catalog.md) — 11 frozen contexts and conceptual authority.
- [Bounded Context canvases](bounded-contexts/canonical-canvases.md) — language, invariants, inputs and outputs.
- [Business ownership matrix](ownership/business-ownership-matrix.md) — source-of-truth ownership.
- [Context Map](context-map/context-map.md) — accepted upstream/downstream relationships and translations.
- [Capability Map](ownership/capability-map.md) — capability families, not BCs.
...
- [EventStorming baseline](processes/eventstorming.md) and [Domain Stories](processes/domain-stories.md) — process evidence and business sequence.
- [Strategic Decision Register](ownership/strategic-decision-register.md) — accepted decisions and superseded proposals.
