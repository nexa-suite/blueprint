...
Capability Mapping, EventStorming, Domain Storytelling, Ubiquitous Language, subdomain discovery, Bounded Context canvases and Context Map — only after the corresponding analysis is performed and evidenced.
...
[Product baseline](../01-product/product-baseline.md), [Pre-DDD architecture baseline](../04-architecture/pre-ddd-baseline.md), [AS-IS evidence](../11-reference/as-is/README.md), [Evolution roadmap](../09-evolution/README.md).
