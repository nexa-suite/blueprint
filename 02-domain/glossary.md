...
| Commercial Commitment | persistent SKU + quantity demand owned by PR/SO | physical reservation or allocation |
| Physical Allocation | selection/authority for Inventory Lot(s) | commercial commitment or picking scan |
| Sellable Availability | usable on-hand minus commitments and Safety Stock | physical stock or Tenant-wide total |
