...
| AUTHORITY | [`00-start-here/current-decisions.md`](../00-start-here/current-decisions.md) | Accepted governance, identity, tenancy and C4 decisions | Technical/domain detail remains separate |
| AS-IS | [`06-delivery/as-is/architecture-implementation-audit.md`](../06-delivery/as-is/architecture-implementation-audit.md) | Current API, Platform, Portal, Website, runtime and test evidence | Describes implementation, not business ownership |
| AS-IS | [`06-delivery/as-is/business-behavior-evidence.md`](../06-delivery/as-is/business-behavior-evidence.md) | Observed flows, events and actors | Historical observations require current-code verification |
| AS-IS | [`06-delivery/as-is/current-terminology-evidence.md`](../06-delivery/as-is/current-terminology-evidence.md) | Terms and semantic collisions | Not final Ubiquitous Language |
