...
| Purchase Request, Commercial Commitment, Sales Order | Sales Commitment | Platform/Portal, Inventory, Fulfillment | commitment is Warehouse-neutral SKU + quantity, no Warehouse/Lot |
| physical stock, Inventory Lot, Sellable Availability, Safety Stock, Inventory Reservation, Warehouse Backing, FEFO | Inventory Availability | Warehouse/Fulfillment, Sales Commitment | deterministic SKU + Warehouse backing may span eligible Warehouses; tenant-wide views are projections |
| Physical Allocation authority | Inventory Availability | Fulfillment & Delivery executes selection/work | later Lot/location allocation cannot exceed committed/backed quantity or usable quantity |
